...
#
# 简洁配置-更新时间[2024-07-01]# 以 ";" 或 "#" 或 "//" 开头的行为注释行
#
# SS-URI scheme 请参考 https://shadowsocks.org/en/spec/SIP002-URI-Scheme.html
#
# Quantumult 使用 HTTP HEAD 方法对测试网址 server_check_url 进行网页响应性测试（测试结果为通过该节点访问此网页获得 HTTP 响应所需要的时间），来确认节点的可用性
...
[server_remote]
# 节点远程订阅
https://wow.dogss-host.store/api/v1/client/subscribe?token=218146b8165100770c21f66b81493b88, tag=SSRDOG, update-interval=172800, opt-parser=false, enabled=true
...
[server_remote]
# 节点远程订阅
https://wow.dogss-host.bond/api/v1/client/subscribe?token=7342446d368b6a85bd5c81d6c8918b82, tag=SSRDOG, update-interval=172800, opt-parser=false, enabled=true
https://dy.tagsub.net/api/v1/client/subscribe?token=3398917d26704d263b9ad451e944ce61, tag=TAGInternet, update-interval=172800, opt-parser=false, enabled=true
https://tagcdnsub.work/api/v1/client/subscribe?token=3398917d26704d263b9ad451e944ce61, tag=TAGInternet, update-interval=172800, opt-parser=false, enabled=false
https://wow.dogss-host.store/api/v1/client/subscribe?token=7342446d368b6a85bd5c81d6c8918b82, tag=SSRDOG, update-interval=172800, opt-parser=false, enabled=false
https://host.api-baobaog.rest/api/v1/client/subscribe?token=7342446d368b6a85bd5c81d6c8918b82, tag=SSRDOG, update-interval=172800, opt-parser=false, enabled=false
